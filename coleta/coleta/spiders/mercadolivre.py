    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            yield {
                ...
                'name' : product.css('h2.ui-search-item__titel::text').get(),
                ...
                'new_price_cents': cents[1] if len(prices) > 0 else None,
                'reviwes_rating_number':product.css('span.ui-search-reviews__rating-number::text').get(),
